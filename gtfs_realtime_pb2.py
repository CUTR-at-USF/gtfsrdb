...
_VEHICLEDESCRIPTOR_OCCUPANCYSTATUS = _descriptor.EnumDescriptor(
  name='OccupancyStatus',
  full_name='transit_realtime.VehicleDescriptor.OccupancyStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_VEHICLEDESCRIPTOR_OCCUPANCYSTATUS)
...
_VEHICLEDESCRIPTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='occupancy_status', full_name='transit_realtime.VehicleDescriptor.occupancy_status', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _VEHICLEDESCRIPTOR_OCCUPANCYSTATUS,
  ],
  options=None,
  is_extendable=True,
  extension_ranges=[(1000, 2000), ],
...
_VEHICLEDESCRIPTOR.fields_by_name['occupancy_status'].enum_type = _VEHICLEDESCRIPTOR_OCCUPANCYSTATUS
_VEHICLEDESCRIPTOR_OCCUPANCYSTATUS.containing_type = _VEHICLEDESCRIPTOR
...
FeedMessage = _reflection.GeneratedProtocolMessageType('FeedMessage', (_message.Message,), dict(
  ...
  __module__ = 'Documents.Projects.gtfsrdb.gtfs_realtime_pb2'
